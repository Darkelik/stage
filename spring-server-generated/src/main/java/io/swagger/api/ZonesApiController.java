...
public class ZonesApiController implements ZonesApi {
    ...
    public ZonesApiController(ObjectMapper objectMapper, HttpServletRequest request) {
    ...
    public ResponseEntity<Void> quietZone(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema(allowableValues={ "basement", "first-floor", "second-floor" }
