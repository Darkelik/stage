...
@Validated
public interface LightingSummaryApi {

    @Operation(summary = "", description = "", tags={ "Z-Wave" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "ok", content = @Content(mediaType = "application/json", schema = @Schema(implementation = LightingSummary.class))) })
    @RequestMapping(value = "/lightingSummary",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<LightingSummary> getLightingSummary();
