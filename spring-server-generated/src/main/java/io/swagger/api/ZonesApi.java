...
public interface ZonesApi {
    ...
    @Operation(summary = "", description = "", tags={ "Zones" })
    @ApiResponses(value = { 
    ...
    ResponseEntity<List<String>> getZones();


    @Operation(summary = "", description = "", tags={ "Zones" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "ok") })
    @RequestMapping(value = "/zones/{zoneId}/quiet",
        method = RequestMethod.GET)
    ResponseEntity<Void> quietZone(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema(allowableValues={ "basement", "first-floor", "second-floor" }
