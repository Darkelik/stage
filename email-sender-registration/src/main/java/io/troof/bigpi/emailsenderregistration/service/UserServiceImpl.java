...
import io.troof.bigpi.emailsenderregistration.repository.ConfirmationTokenRepository;
import io.troof.bigpi.emailsenderregistration.repository.UserRepository;
...
public class UserServiceImpl implements UserService {
  ...
  public ResponseEntity<?> confirmEmail(String confirmationToken) {
    ConfirmationToken tok = confirmationTokenRepository.findByConfirmationToken(confirmationToken);

    if (tok != null) {
      User user = userRepository.findByUserEmailIgnoreCase(tok.getUserEntity().getUserEmail());
